                    ...
                    Column(
                        ...
                        Column(
                            ...
                            Row(
                                ...
                                Text(text = stringResource(R.string.codigo_venda), fontSize = 14.sp)
            ...
            Column(
                ...
                Box(
                    ...
                    Row(
                        ...
                        Text(text = stringResource(R.string.codigo), fontSize = 14.sp)
                        ...
                        Text(text = stringResource(R.string.tipo_venda), fontSize = 14.sp)
